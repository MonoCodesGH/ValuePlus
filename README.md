...
| `FormatPlural(value, capitalize)` | `value: string`<br>`capitialize: boolean?` | `string` | Converts a string into plural grammer.       |
| `StringAsColor(value, color)`     | `value: string`<br>`color: Color3`         | `string` | Converts a string into a color string.       |
